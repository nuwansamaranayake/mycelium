...
## FAIL-0009 — Eval report embedded an environment-dependent line, breaking byte-reproducibility across environments
...
## FAIL-0012 — Every published hostname 404ed at the root URL

- **Date**: 2026-07-27
- **Surface**: `GET /` on `https://mycelium.aigniteconsulting.ai`
